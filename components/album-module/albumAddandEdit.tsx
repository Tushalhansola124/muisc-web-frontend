...
import { CreateAlbum, UpdateAlbum, GetAlbumById } from "./controller"
...
export default function AlbumForm({ albumId, isEdit = false }: AlbumFormProps) {
  ...
  useEffect(() => {
    ...
    fetchAlbum()
  }, [isEdit, albumId, setValue, artists])
...
>
  <SelectTrigger className="w-full">
    ...
    <SelectValue placeholder="Select Artist">
      {
        artists.find(
          (artist) => artist._id === watch("artist")
        )?.name || "Select Artist"
      }
    </SelectValue>
