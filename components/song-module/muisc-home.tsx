...
//         {/* ── MAIN CONTENT ──────────────────────────────────── */}
//         <main className="flex-1 overflow-y-auto bg-linear-to-b from-[#111118] to-[#0a0a0f] w-full min-w-0">
...
//               <div className="w-7 h-7 rounded-full bg-linear-to-br from-violet-500 to-pink-500 flex items-center justify-center text-xs font-bold">{session?.user?.firstName?.charAt(0).toUpperCase() || "N"}</div>
